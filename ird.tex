...
\begin{frame}{FRA: Brigo-Mercurio Approach}
	\begin{itemize}
		...
		\begin{equation}
			\boxed{\textbf{FRA}(t,T,S,\tau,N,K)=N[P(t,S)\tau K–P(t,T)+P(t,S)]}\myendproof
		\end{equation}
	\end{itemize}
\end{frame}
...
\begin{frame}{Swap and Bond Switching}
	\begin{itemize}
		...
		\begin{equation*}
			\boxed{\textbf{PFS}(t,T_\alpha,T_\beta,\tau,N,K)=N(P(t,T_\alpha)-P(t,T_\beta))-NK\sum_{i=\alpha+1}^{\beta} \tau_iP(t,T_i)}
		\end{equation*}
