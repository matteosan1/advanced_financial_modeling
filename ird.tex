...
\begin{itemize}
	...
	\begin{columns}
		...
		\begin{center}
			\includegraphics[width=1.1\linewidth]{swap_curve}
		\end{center}
...
\begin{frame}{Basis Swap}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[width=0.6\linewidth]{tenor_basis_swap}
	\end{center}
\end{frame}
...
\begin{frame}{Basis Swap Spread}
	...
	\column{0.4\linewidth}
		\begin{center}
		\includegraphics[width=1.1\linewidth]{Basis-Swap-spreads-Euribor-3M-Vs-Euribor-6M-Euribor-6M-Vs-Euribor-12M-and-Eonia-Vs}
		\end{center}
	\end{columns}
	\end{itemize}
...
\uncover<5->{	
\begin{tikzpicture}[remember picture,overlay]
	\node[xshift=1.5cm,yshift=-3.9cm] (image) at (current page.center) {\includegraphics[width=80px]{python}};
\end{tikzpicture}}
\end{columns}
\end{itemize}
\end{frame}
