...
\begin{frame}{Negative Swap Spreads}
	...
	\item \emph{Credit Risk Differences}: during extreme "flight to quality" events, the perceived credit risk of even highly rated financial institutions can increase, causing swap rates to decline relative to Treasury yields.
	\begin{columns}
		\column{0.5\linewidth}
		\begin{center}
		\includegraphics[width=0.7\linewidth]{images/swap_spread}
		\end{center}
