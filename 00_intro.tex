...
\subtitle{a.k.a. Interest Rate Derivatives}
...
\begin{frame}{The Course}
	...
	\begin{table}[bt]
		\begin{tabular}{|l|c|c|} \hline
			...
			Tuesday & 7 & 12.00-13.30 \\ \hline
			\textcolor{lightgray}{Wednesday} & \textcolor{lightgray}{10} & \textcolor{lightgray}{12.00-13.30} \\ \hline
			Thursday & 10 & 12.00-13.30 \\ \hline
		\end{tabular}
	\end{table}
\end{frame}
...
\begin{frame}{Syllabus}
	\begin{itemize}	
		\item During the course practical applications and exercises on the discussed subjects will be presented.
		...
		\item For those interested, some mathematical techniques for finance are described \href{https://drive.google.com/file/d/1iKw9KOBvBwN4GXEBt0seGQ3EZutr44O0/view?usp=drive_link}{here} along with a short \texttt{python} introduction.
		\item You can of course look into the huge amount of resources available online.
	\end{itemize}
	\begin{center}
	\textcolor{orange}{Not sure if a Moodle space is available (I'll check), for the time being I'll upload all the material on \href{https://drive.google.com/drive/folders/1fVm-yim0zBlgHfISA9e6L9aryijZb84t?usp=drive_link}{GoogleDrive}.}
	\end{center}
\end{frame}

\begin{frame}{Examination}
	\begin{itemize}	
		\item The exam will consist of a written and an \emph{optional} oral part: 
		\begin{enumerate}
			\item the \textbf{written part}, consists of 4 exercises \emph{similar} to those discussed in classroom;
			\item the \textbf{oral part}, where you will be asked to prepare a short seminar on selected topics to present us during the last lessons of the course.
			An initial set of proposed topics can be found \href{https://drive.google.com/file/d/1zjOqDbDBlbtC1dPqZNUHRVFndzihTwaK/view?usp=drive_link}{in this PDF}, nevertheless you can 
			propose other subjects, following discussion with the teachers. 
		\end{enumerate} 
	\end{itemize}
\end{frame}
