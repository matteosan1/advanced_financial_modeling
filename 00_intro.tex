...
\begin{frame}{Syllabus}
	...
	\end{itemize}
	\begin{center}
	\textcolor{orange}{Not sure if a Moodle space is available, so I'll upload all the material on \href{https://drive.google.com/file/d/1GnlyuB4KkUbzqL7tf6nju-ZEqnfQrRa4/view?usp=drive_link}{GoogleDrive}.}
	\end{center}
\end{frame}
...
\begin{frame}{Examination}
	\begin{itemize}	
		...
		\begin{enumerate}
			...
			An initial set of proposed topics can be found \href{https://drive.google.com/file/d/1GnlyuB4KkUbzqL7tf6nju-ZEqnfQrRa4/view?usp=drive_link}{in this PDF}, nevertheless you can 
