...
\begin{frame}{An Example \colablink{https://colab.research.google.com/drive/1OptLgmcdJOcg-ks_DcJvTBgl_g5qTMvN}}
	...
	\begin{enumerate}
		...
		\item Verify that applying the Radon-Nikodym to simulated process paths the drift indeed disappear.
	\end{enumerate}
	\begin{center}
...
\begin{frame}{The Vasicek Model under $\mathbb{P}$ \colablink{https://colab.research.google.com/drive/156o259BDfNHaYTvR8TUHmNRa-U5Q20Cj}}
	\begin{itemize}
