...
Suppose we have a $1\times 4$ FRA with a notional principal of €1 million. We are at the settlement date, when the 90-day LIBOR is 6\% and the contract rate is 5.5\%. Calculate the value of the FRA.
...
\begin{parts}
	...
	The Asset Swap Spread $s$ is the "price of risk." Using the relationship:
	\begin{equation*}
...
Apply the change of measure technique from risk neutral to T-forward measure to the risk neutral pricing formula of a generic payoff $V$.
Explain also the rationale behind this strategy. 
