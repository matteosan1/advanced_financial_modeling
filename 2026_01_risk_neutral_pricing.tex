...
\begin{frame}{Deterministic vs Stochastic}
	\begin{itemize}
		...
		\end{equation*}
		(the risk-neutral measure is often denoted by $\mathbb{Q}^0$ or $\mathbb{Q}^B$, and similarly for the expectations).
...
\begin{frame}{Spot Interest Rate}
	\begin{itemize}
		\item Simply-compounded \textcolor{maincolor}{spot interest rate}
		\begin{equation}
...
\begin{frame}{FRA Valuation: Brigo-Mercurio Approach}
	\begin{itemize}
		...
		\end{equation*}
		\item<1-> If you remember the payout is expressed at time $S$ it becomes, at time $t$:
		\begin{equation*}
